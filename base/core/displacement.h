...
namespace Displacement {
	...
	inline uintptr_t* EntityListBase = *( uintptr_t** ) ( ( ( uintptr_t ) GetModuleHandleA( "ac_client.exe" ) ) + 0x18AC04 );// this was messing up and i cant be bothered finding out why so im hardcoding the offset here
